    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <button 
                    type="submit" 
                    class="w-full bg-green-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-200 flex items-center justify-center"
                >
